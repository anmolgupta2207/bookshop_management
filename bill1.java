...
class bill1 extends JFrame implements ActionListener
{
    Container c1;
    JFrame bfrm;
	JPanel bpan1,bpan2;
  		  ...
  		  tf2.addKeyListener(new KeyAdapter() 
    {
    	...
    	char c = e.getKeyChar();      
  		  ...
  		  txtQB.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
  		 ...
  		 txtQN.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
  		 ...
  		 txtQS.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
		...
		l2=new JLabel("Ph.No :-09860187477");
      ...
      b1.addActionListener(this);
        ...
        public void actionPerformed(ActionEvent e1)
       {
              	...
              	if(obj==b1)
		{
				...
				PrintJob pjob = Toolkit.getDefaultToolkit().getPrintJob(this,"Print Report",null); 
            }

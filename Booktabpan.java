...
class Booktabpan extends JFrame implements ActionListener
{
            ...
            bookname.addKeyListener(new KeyAdapter() 
    {
    	...
    	char c = e.getKeyChar();      
  		...
  		bauther.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (((Character.isDigit(c)))) 
      	//if(!((c>=65 && c<=90) || (c>=97 && c<=122)))
  		  ...
  		  bpubl.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (((Character.isDigit(c)))) 
      	//if(!((c>=65 && c<=90) || (c>=97 && c<=122)))
  		  ...
  		  bscost.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
  		   ...
  		   bpcost.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
  		  ...
  		  bquantity.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
        ...
        nbookname.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (((Character.isDigit(c)))) 
        ...
        nbtype.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (((Character.isDigit(c)))) 
  		...
  		nbscost.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
		...
		nbpcost.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
  		...
  		nbquantity.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
        ...
        stname.addKeyListener(new KeyAdapter() 
    {
    	...
    	char c = e.getKeyChar();      
  		...
  		stmanuf.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (((Character.isDigit(c)))) 
  	...
  	stscost.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
  	...
  	stpcost.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
  	...
  	stquantity.addKeyListener(new KeyAdapter() 
    {
        public void keyTyped(KeyEvent e) {
    	char c = e.getKeyChar();      
      		if (!((Character.isDigit(c) || (c == KeyEvent.VK_BACK_SPACE) || (c == KeyEvent.VK_DELETE)))) 
    ...
    public void actionPerformed(ActionEvent e1)
       {
			 ...
			 if(obj==sb) //book search
             {
			      try
                    {
                       Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
			   		   ...
			   		   if(rs1.next())
                        {
                     //    bookid.setInt(rs1.Integer.parseInt.gettext(1));
              ...
              if(obj==eb) //book update  bookname,bookid,bauther,bpubl,bscost,bpcost,bquantity;
              {
                   try
                    {   s1=null;
                     int i = JOptionPane.showConfirmDialog(fdist,"Do you want to Update","Update?",JOptionPane.YES_NO_OPTION);
                     if(i== JOptionPane.YES_OPTION){
                       String sbookid = bookid.getText();//"WHERE distid='"+sdistid+"'";
                       s1 = con.createStatement();

                       //String q = "UPDATE bookdetails SET book_name='"+bookname.getText()+"', auther='"+bauther.getText()+"',publication='"+bpubl.getText()+"', sale_cost="+ bscost.getText()+", purchase_cc="+bpcost.getText()+", quantity="+bquantity.getText()+" WHERE book_id="+sbookid;
                      String q="update bookdetails SET book_name='"+bookname.getText()+"', auther='"+bauther.getText()+"', publication='"+bpubl.getText()+"',sale_cost="+ Integer.parseInt(bscost.getText()) +",purchase_cost="+ Integer.parseInt(bpcost.getText())+", quantity="+Integer.parseInt(bquantity.getText())+ " where book_id="+ sbookid;
